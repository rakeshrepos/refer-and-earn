    ...
    <div id="app">
        ...
        <div class="flex">
            <div class="flex flex-col bg-slate-900 w-[15rem] h-screen top-[3.8rem] fixed py-[2rem]">
                ...
                <a href="{{route('subAdmin.users')}}" class="nav flex items-center text-white px-[3rem] hover:bg-black h-[4rem]">
                    Users
                </a>
                <a href="{{route('subAdmin.addUser')}}" class="nav flex items-center text-white px-[3rem] hover:bg-black h-[4rem]">
                    Add User
                </a>
            </div>
